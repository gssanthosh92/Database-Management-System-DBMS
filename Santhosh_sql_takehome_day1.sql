...
select CUSTOMER_ID,ORDER_ID,ORDER_DATE,ORDER_SHIPMENT_DATE from order_header where ORDER_SHIPMENT_DATE is not null order by CUSTOMER_ID and ORDER_DATE desc;

-- 8.	Write a query to List the details of products with class code 2050 where price is in the range of 1000 and 30000 and available quantity is more than 15.(2 ROWS) [NOTE: PRODUCT TABLE].
select * from product where PRODUCT_CLASS_CODE=2050 and PRODUCT_PRICE between 1000 and 30000 and PRODUCT_QUANTITY_AVAIL>=15;
